#include "ZCWriterStream.h"

#include <sys/types.h>
#include <sys/socket.h>

ZCkWriterStream::ZCWriterStream(
  int fd,
...
ZCWriterStream::~ZCWriterStream()
{
}

//--------------------------------------------------------------------------------------------------

bool ZCWriterStream::Next(void** data, int* size) {
...
void ZCWriterStream::BackUp(int count) {
  m_numBytesToWrite -= count;
}

//--------------------------------------------------------------------------------------------------

protobuf::int64 ZCWriterStream::ByteCount() const {
  return m_byteCount;
}

//--------------------------------------------------------------------------------------------------

bool ZCWriterStream::Flush() {
