#ifndef __ZC_READER_STREAM_H__
#define __ZC_READER_STREAM_H__

#include <google/protobuf/io/zero_copy_stream.h>

namespace protobuf = google::protobuf;

class ZCReaderStream : public protobuf::io::ZCInputStream {
public:
...
private:
 GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(ZCReaderStream);
};
